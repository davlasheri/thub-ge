...
export const CATALOG: CatalogSection[] = [
  ...
  // ── GROUP 16: HV BATTERY ───────────────────────────────────────────────────
  {
    ...
    name: 'HV Battery System', nameGe: 'HV ბატარეა',
    icon: '🔋',
  ...
  // ── GROUP 18: THERMAL MANAGEMENT ──────────────────────────────────────────
  {
    ...
    name: 'Thermal Management', nameGe: 'სითბოს მართვა',
    icon: '🌡️',
  ...
  {
    id: 'susp-brakes', groupNumber: 19,
    name: 'Suspension, Steering & Brakes', nameGe: 'საკიდი და მუხრუჭები',
    icon: '⚙️',
  ...
  // ── GROUP 20: SAFETY & RESTRAINT ──────────────────────────────────────────
  {
    ...
    name: 'Safety & Restraint', nameGe: 'უსაფრთხოება',
    icon: '🛡️',
  ...
  {
    id: 'drivetrain',
    name: 'Drivetrain', nameGe: 'ამძრავი სისტემა',
    icon: '🔄',
    image: 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=400&q=70',
    subsections: [
